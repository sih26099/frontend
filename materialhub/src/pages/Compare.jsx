...
export default function Compare() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white border border-ink-200 rounded-md p-4 grid sm:grid-cols-2 gap-4">
      ...
      {!loading && !error && result && (
        <div className="space-y-4">
          <div className="flex items-center justify-between flex-wrap gap-2 bg-white border border-ink-200 rounded-md p-4">
            <div>
