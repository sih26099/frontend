...
export default function ApprovalDetail() {
  ...
  return (
    <div className="space-y-4">
      ...
      {candidate && (
        <>
          <div className="bg-white border border-ink-200 rounded-md p-4 flex items-center justify-between flex-wrap gap-2">
      ...
      {isPending && (
        <div className="bg-white border border-ink-200 rounded-md p-4 flex flex-wrap gap-2 sticky bottom-4">
