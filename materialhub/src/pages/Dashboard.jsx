  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
        <StatCard label="Total materials" value={fmtNumber(stats.total_materials)} />
        <StatCard label="CPSEs connected" value={fmtNumber(cpseEntries.length)} />
        <StatCard label="Match candidates" value={fmtNumber(totalMatchCandidates)} />
        <StatCard label="Pending approvals" value={fmtNumber(stats.pending_approvals)} />
        <StatCard label="National codes" value={fmtNumber(stats.total_national_codes)} />
        <StatCard
...
function HowMatchingWorks() {
  return (
    <details className="bg-white border border-ink-200 rounded-md p-4 group">
